...
#define SCRIPT_CONSTANTS_HPP
	...
	export_constant2("bMammoniteDiscount", SP_MAMMONITE);
	...
	//Instance Difficulty Penalties [InstanceMode]
	...
	//Instance Difficulty Buff
	export_constant(SC_II_CAST);
	export_constant(SC_II_ASPD);
	export_constant(SC_II_MAXHP);
	export_constant(SC_II_MAXSP);
	export_constant(SC_II_ALLSTATS);
	export_constant(SC_II_SPEED);
	export_constant(SC_II_ATK);
	export_constant(SC_II_MATK);
...
/// @APIHOOK_START(EFST_CONST)
	...
	export_constant(EFST_ID_MAXHP);
	export_constant(EFST_ID_MAXSP);
	export_constant(EFST_ID_ALLSTATS);
	export_constant(EFST_ID_SPEED);
	export_constant(EFST_ID_ATK);
	export_constant(EFST_ID_MATK);
	export_constant(EFST_II_CAST);
	export_constant(EFST_II_ASPD);
	export_constant(EFST_II_MAXHP);
	export_constant(EFST_II_MAXSP);
	export_constant(EFST_II_ALLSTATS);
