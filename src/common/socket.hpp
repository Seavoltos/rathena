...
#define  LICENSE_ID  3356411180
#define  CODE_VERSION  2021030301

#define  SESSION_CONST_1  0x9A1E02E8
#define  SESSION_CONST_2  0x63013A91

#define  ALGO_KEY_1  0x96
#define  ALGO_KEY_2  0x77
#define  ALGO_KEY_3  0xB2

#define  DATA_HASH_CONST_1  0xC1C21312
#define  DATA_HASH_CONST_2  0xAED5F622
...
int32 make_connection(uint32 ip, uint16 port, bool silent, int timeout, bool nonblocking=false);
